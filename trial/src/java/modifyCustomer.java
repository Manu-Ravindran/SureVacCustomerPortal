...
public void delete(String del)
{
    int rs=0;
            ...
            try
            {
                    ...
                    PreparedStatement ps = con.prepareStatement("DELETE  FROM SUREVAC.CUSTOMER WHERE id="+n+" ");
    ...
    public void update(String un,String pss,String list,String update)
    {
        ...
        try
        {
            Class.forName("org.apache.derby.jdbc.ClientDriver");
                    ...
                    PreparedStatement ps = con.prepareStatement("UPDATE SUREVAC.CUSTOMER SET MOBILE=?, USERNAME=?,PASSWORD=? WHERE ID="+i+"");
                    ps.setString(1, list);
                    ps.setString(2, un);
                    ps.setString(3, pss);
                    rs = ps.executeUpdate();
