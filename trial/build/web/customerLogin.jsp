<%-- 
    ...
    Created on : 23 Oct, 2018, 11:16:51 PM
    Author     : Sajid
--%>
...
<script type="text/javascript" src="forjs/jspdf.min.js"></script>
<script type="text/javascript" src="forjs/html2canvas.js"></script>
