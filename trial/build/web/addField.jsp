<%-- 
    Document   : addField
    Created on : 21 Oct, 2018, 4:30:43 AM
    Author     : Sajid
--%>
...
<form action="AddingField">
  <div class="container">
    <h1>Add Field Engineer</h1>
    ...
    <input type="text" placeholder="Enter Username" name="Euser" required>
    ...
    <div class="container">
    <form action="modifyField" method="post">
    <div class="row">
        <center><h2>Delete FIELD ENGINEER Account</h2></center>
      <div class="col-25">
       ...
       <select name="na">
        ...
        <%
            Class.forName("org.apache.derby.jdbc.ClientDriver");
                    ...
                    PreparedStatement ps = con.prepareStatement("select * from SUREVAC.USERS where CLEARANCE='field'");
...
<div class="container">
    <form action="modifyField" method="post">
    <div class="row">
        <center><h2>Update FIELD ENGINEER Account</h2></center>
      <div class="col-25">
        <label for="Pname"> Name</label>
      </div>
      <div class="col-75">
