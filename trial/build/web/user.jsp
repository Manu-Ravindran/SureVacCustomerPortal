<%-- 
    Document   : user
    Created on : 22 Oct, 2018, 3:25:03 AM
    Author     : Sajid
--%>
...
<div class="sidebar">
  ...
  <a href="modUser.jsp" target="mn1">MANAGE USER</a>
  <a href="addField.jsp" target="mn1">MANAGE Field Engineer</a>
  <a href="addCustomer.jsp" target="mn1"> MANAGE Customer Accounts</a>
  <a href="assignFE.jsp" target="mn1">ASSIGN F.E</a>
