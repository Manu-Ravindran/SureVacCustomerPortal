<%-- 
    Document   : addUser
    Created on : 21 Oct, 2018, 4:26:46 AM
    Author     : Sajid
--%>
...
<form action="AddingUsers">
  <div class="container">
    ...
    <div class="row">
        <center><h2>Delete USER Account</h2></center>
      <div class="col-25">
       ...
       <select name="na">
        ...
        <%
            Class.forName("org.apache.derby.jdbc.ClientDriver");
                    ...
                    PreparedStatement ps = con.prepareStatement("select * from SUREVAC.USERS where CLEARANCE='user'");
